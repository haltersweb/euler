...
from helpers_mine.is_prime import is_prime # helper method I wrote to test number for prime

# Solve brute force as a factor tree
# this loops through odd numbers after 2, testing for prime each time.
...
# only tests prime factors, but iterates up to the largest factor rather than testing quotient after a factoring
...
# 2*2*2*2•3*7*29*29*10000019 = 2825765368944 largest prime = 10000019 *TRIAL 1: 0.09275 ms TRIAL 2: 280.54671 ms
...
print(f"for n = 600000000018 largest prime is:", largest_prime_brute(2825765368944))
...
print(f"for n = 600000000018 largest prime is:", largest_prime_pure_iteration(2825765368944))
...
print(f"for n = 600000000018 largest prime is:", largest_prime_test_only_factors(2825765368944))
